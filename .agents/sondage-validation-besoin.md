# Sondage de validation du besoin — projet valio

*Instrument de découverte pré-produit — à copier-coller dans Google Forms.*
*Créé le 2026-07-29 · **réécrit le 2026-08-05** (v2).*
*Cible : formateurs / enseignants francophones, Madagascar d'abord.*

## Ce qui a changé en v2, et pourquoi

La v1 présentait valio comme un **produit fini**, captures d'écran à l'appui, puis demandait
« dans quelle mesure ce produit répond-il à un besoin ? ». Trois défauts rédhibitoires dès lors
qu'une **refonte complète reste sur la table** :

1. **Elle ancrait le répondant sur la solution existante.** Montrer un produit abouti oriente
   les réponses vers « c'est bien / c'est pas bien » au lieu de « voici ce dont j'ai besoin ».
   On ne pouvait pratiquement pas en sortir une invalidation.
2. **Elle demandait des intentions futures** (« paieriez-vous ? »), alors que les intentions
   déclarées prédisent mal les comportements. Le passé récent, lui, est vérifiable.
3. **Elle laissait peu de place à l'expression** — presque que du choix fermé, donc aucun
   vocabulaire client récolté, alors que c'est la matière première de tout le reste.

La v2 corrige les trois. **Principe directeur :**

> Le produit n'existe pas. On enquête sur le **travail à faire**, pas sur une application.
> Le concept n'est évoqué qu'après que le répondant a décrit son propre idéal — et **jamais
> en images**, pour ne pas figer une implémentation qu'on est prêt à jeter.

## Ce que ce sondage doit produire
...
**Titre** : Comment évaluez-vous vos apprenants ?

**Description (haut de formulaire)** :
> Nous concevons un outil d'évaluation pour les formateurs et enseignants, et **rien n'est
> encore décidé** — c'est justement pour cela que nous vous posons ces questions maintenant.
> Vos réponses peuvent nous faire changer complètement de direction.
>
> Comptez **10 à 12 minutes**, ou 6 si vous ne remplissez que les questions obligatoires.
> Il n'y a pas de bonne réponse : dites-nous ce qui se passe vraiment chez vous, y compris si
> tout va bien.
>
> **Ce que nous vous demandons et pourquoi.** Ce questionnaire n'est pas anonyme : nous vous
> demandons votre e-mail pour pouvoir revenir vers vous, vous donner accès à l'outil en
> avant-première et vous dire ce que vos réponses ont changé. Vos réponses ne sont **ni
> publiées, ni transmises à un tiers**, et votre nom n'apparaîtra jamais à côté d'un
> commentaire. Vous pouvez laisser vide toute question qui vous met mal à l'aise — un champ
> vide nous est plus utile qu'une réponse de politesse.

---

### Section 1 — Vous

**Q1. Quel est votre rôle principal ?** *(choix unique — obligatoire)*
- Formateur / enseignant indépendant
- Enseignant en établissement (école, collège, lycée, université)
- Formateur en entreprise / organisme de formation
- Responsable pédagogique / direction d'établissement
- Responsable formation / RH
- Autre…

**Q2. Qu'enseignez-vous ?** *(réponse courte — obligatoire)*
> *Segmentation : les besoins d'un prof de maths et d'un formateur en soft skills n'ont rien
> à voir. Champ libre volontaire — une liste fermée nous ferait rater des segments.*

**Q3. Où exercez-vous principalement ?** *(choix unique — obligatoire)*
- Madagascar
- Autre pays francophone *(préciser…)*

**Q4. Combien de personnes évaluez-vous en moyenne par session ?** *(choix unique — obligatoire)*
- Moins de 10 · 10 à 20 · 20 à 40 · Plus de 40

**Q5. À quelle fréquence faites-vous passer une évaluation notée ?** *(choix unique — obligatoire)*
- Plusieurs fois par semaine · Environ 1 fois par semaine · 1 à 2 fois par mois
- Quelques fois par an · Jamais

**Q6. À quel moment votre charge de correction est-elle la plus lourde ?** *(choix unique — obligatoire)*
- En période de contrôles / d'examens
- En fin de trimestre ou de semestre
- De manière continue, tout au long de l'année
- Elle n'est jamais vraiment lourde
> *Cale le message **et le calendrier de lancement**. Une urgence ne se décrète pas, elle
> s'attache à un moment daté.*

---

### Section 2 — Votre dernière évaluation

> *Le cœur du questionnaire. On demande un **épisode réel et daté**, pas une opinion générale :
> ce qui s'est passé est vérifiable, ce qu'on ferait « en général » ne l'est pas.*

**Q7. Quand a eu lieu votre dernière évaluation notée ?** *(choix unique — obligatoire)*
- Cette semaine · Ce mois-ci · Ce trimestre · Il y a plus longtemps · Jamais

**Q8. Racontez-nous comment ça s'est passé** — de la préparation à la remise des notes.
*(réponse longue — obligatoire)*
> *La question la plus précieuse du formulaire. C'est ici qu'on récolte les mots exacts des
> formateurs, qui alimenteront la section* Customer Language *de `product-marketing.md`.*

**Q9. Au total, combien de temps cela vous a-t-il pris ?** *(choix unique — obligatoire)*
- Moins de 30 min · 30 min à 1 h · 1 à 3 h · 3 à 6 h · Plus de 6 h

**Q10. Quelle partie vous a pris le plus de temps ?** *(choix unique — obligatoire)*
- Préparer les questions
- Faire passer l'épreuve
- Corriger
- Calculer et reporter les notes
...
- Le suivi des progrès d'un élève dans le temps
- Un mode devoir à la maison (asynchrone, sans être tous connectés en même temps)
- Un export PDF / impression papier
- Des statistiques par question (ce qui n'a pas été compris)
- Un côté jeu, motivant pour les apprenants
- L'import de mes questions depuis Word ou Excel
- La détection de triche
- Aucune de ces capacités ne changerait ma façon de faire
- Autre…

> ⚠️ **Cette liste dépasse volontairement ce que le projet sait faire.** Banque de questions,
> suivi longitudinal, mode asynchrone, import Word, détection de triche : rien de tout cela
...
> **Ne mettre aucune capture d'écran.** Le concept est décrit en mots, au conditionnel, pour
...
> un **code et un pseudo, sans créer de compte**. Ils répondent sous un temps limité. À la
> fin, vous obtenez un classement et **une note sur 20 pour chacun** — y compris pour les
...
- Non, je le réserverais à de la révision
- Non, jamais
- Je ne sais pas
...
- Gratuit uniquement, je ne paierais pas
- Autre…
...
- Personne, ce type d'outil devrait être gratuit
- Autre…
...
- Un peu
- Non, ce n'était pas un souci pour moi
- Je ne comprends pas la question
> *Valide la garantie. L'option « je ne comprends pas » est là exprès : si elle est souvent
> cochée, c'est la formulation qu'il faut revoir, pas la garantie.*
...
- Recherche Google
- Réseaux sociaux (YouTube, TikTok…)
- Formation ou collègues de mon établissement
- Je n'en cherche jamais
- Autre…
...
- **6 sections** natives — lisibilité sur smartphone modeste, contexte fréquent de la cible.
...
## Comment dépouiller les réponses ouvertes

Une douzaine de champs libres ne servent à rien sans protocole. Pour chaque question ouverte :

1. **Lire tout une première fois sans rien coder** — repérer les thèmes qui émergent seuls.
2. **Coder chaque réponse** par thème (une réponse peut en porter plusieurs), puis compter
   **fréquence × intensité** — l'intensité se lit dans les mots employés (« pénible »,
   « je déteste », « des heures » pèsent plus qu'un constat neutre).
3. **Extraire 5 à 10 verbatims** par thème dominant, **mot pour mot**, jamais reformulés. Ce
   sont eux qui alimentent la section *Customer Language* de `product-marketing.md` et, plus
   tard, les textes de la vitrine.
4. **Étiqueter chaque conclusion** avec un niveau de confiance :

| Confiance | Critère |
|---|---|
| **Élevée** | Thème présent chez 3+ répondants indépendants, exprimé spontanément, stable entre segments |
...
Dépouiller **sur le segment cœur** (Q1 = formateur/enseignant **et** Q3 = Madagascar).
...
### Le concept répond-il à ce besoin ?
...
la dernière ligne de chaque tableau dit quoi.
